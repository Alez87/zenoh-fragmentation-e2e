...
pub fn setup_put(
    ...
    value: &str,
    chunk_size: usize,
) -> (Properties, String, String, usize) {
...
pub async fn call_get(
    ...
    zenohcdn.set_download_folders(GETApiFoldersArgs {
        root_folder_final,
        root_folder_chunks,
    });
    zenohcdn.set_download_bytes_args(GETApiChunksArgs {
        index_start,
        index_end,
        chunk_index_start,
        chunk_index_end,
...
pub async fn call_eval(
    ...
    match zenoh_cdn
        .run_eval_e2e(path, EVALApiArgs { chunk_size })
        .await
    {
        Ok(_) => {
